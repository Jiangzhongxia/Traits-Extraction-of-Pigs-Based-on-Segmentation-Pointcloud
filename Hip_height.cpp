...
//    std::string output_path = "E:\\pig1-150\\xyz150\\xyz150\\014_new\\Hip_height\\points.pcd";
//
//    // 创建点云指针
...
//
//    // 输出降采样后的点云
//    pcl::io::savePCDFile("E:\\pig1-150\\xyz150\\xyz150\\014_new\\Hip_height\\downsampled_plane.pcd", *downsampled_cloud);
...
//    pcl::PointXYZ back_center;
//    back_center.x = (center3.x + center4.x) / 2.0f;
//    back_center.y = (center3.y + center4.y) / 2.0f;
//    back_center.z = (center3.z + center4.z) / 2.0f;
//    // 设置搜索半径
//    float radius = 0.01f; // 根据需要调整这个半径值
//    // 根据前中后中心找到对应领域的点集质心
//    pcl::PointXYZ p1 = findRegionCentroid(back_part, back_center.x, back_center.z, back_center.y, radius);
//    // 计算点到平面在 y 轴方向的距离
...
//    std::cout << "Hip_height =  " << distance << std::endl;
//    std::ofstream output_file("E:\\pig1-150\\xyz150\\xyz150\\014_new\\Hip_height\\distance.txt");  // 打开文件（会自动创建或覆盖）
//
