...
//    pcl::io::savePCDFileASCII("E:\\pig1-150\\xyz150\\xyz150\\014_new\\adbominal_grith\\curve_points.pcd", *cloud);
...
//    // 将曲线长度写入到txt文件
//    std::ofstream output_file("E:\\pig1-150\\xyz150\\xyz150\\150\\adbominal_grith\\curve_length.txt");  // 打开文件（会自动创建或覆盖）
//
...
//    }
//
//    // 找到 lower_part 和 upper_part 在 x 轴的最小值和最大值
...
//
//    // 获取x轴的中间点
//    float x_mid_lower = (min_lower_x.x + max_lower_x.x) / 2.0f;
//    float x_mid_upper = (min_upper_x.x + max_upper_x.x) / 2.0f;
//
//    // 固定的1cm切片范围，前后各0.5cm
//    const float slice_thickness = 0.9f;  // 0.5cm = 0.9m
//
//    // 基于x轴的范围切片，前后0.5cm的范围
//    pcl::PassThrough<pcl::PointXYZ> pass;
//    pass.setFilterFieldName("x");
//
//    // 对lower_part进行x轴的前后0.5cm范围切片
//    pass.setFilterLimits(x_mid_lower - slice_thickness, x_mid_lower + slice_thickness);
...
//
//    // 对upper_part进行x轴的前后0.5cm范围切片
//    pass.setFilterLimits(x_mid_upper - slice_thickness, x_mid_upper + slice_thickness);
...
//
//    // 保存合并后的切片为PCD文件
//    pcl::io::savePCDFileASCII("E:\\pig1-150\\xyz150\\xyz150\\014_new\\adbominal_grith\\points_cut.pcd", *lower_slice);
//
//    return lower_slice;
//}
//
...
//    std::string output_path = "E:\\pig1-150\\xyz150\\xyz150\\014_new\\adbominal_grith\\points.pcd";
//
//    // 创建点云指针
...
//    pcl::io::savePCDFileASCII("E:\\pig1-150\\xyz150\\xyz150\\014_new\\adbominal_grith\\55_cen.pcd", *middle_part);
