...
{
  const std::string fname = (argc>1) ? argv[1] : CGAL::data_file_path("E:\\Pig_Cattle\\Pigpoints_3\\3.xyz");
  const char* output_fname = (argc > 2) ? argv[2] : "E:\\Pig_Cattle\\Pigpoints_3\\3_smoothed.xyz";
