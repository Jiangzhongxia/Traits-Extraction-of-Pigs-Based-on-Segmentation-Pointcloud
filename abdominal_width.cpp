...
//    std::string output_path = "E:\\pig1-150\\xyz150\\xyz150\\014_new\\abdominal_width\\points.pcd";
//
//    // 创建点云指针
...
//
//    for (const auto& point : middle_part->points) {
...
//    float front_slice_max_x = min_x + 0.05f;
//
//    float back_slice_min_x = max_x - 0.05f;
//    float back_slice_max_x = max_x;
//
//    // 切出前后 5cm 的切片
//    pcl::PointCloud<pcl::PointXYZ>::Ptr front_slice = slicePointCloud(middle_part, front_slice_min_x, front_slice_max_x);
//    pcl::PointCloud<pcl::PointXYZ>::Ptr back_slice = slicePointCloud(middle_part, back_slice_min_x, back_slice_max_x);
...
//    pcl::PointXYZ P1 = findP1(middle_part);
//    pcl::PointXYZ P2 = findP2(middle_part);
//    float A, B, C, D;
//    fitPlane(max, min, A, B, C, D);
//
//    double totalDistance = findMaxDistanceSum(middle_part, A, B, C, D);
//    float resolution = 0.8; 
//    //std::cout<< "totalDistance = " << totalDistance << endl;
//    std::cout << "abdominal_width =  " << totalDistance << std::endl;
//    std::ofstream output_file("E:\\pig1-150\\xyz150\\xyz150\\014_new\\abdominal_width\\abdominal_width.txt");  // 打开文件（会自动创建或覆盖）
//
//    if (output_file.is_open()) {
//        // 将曲线长度写入文件
//        output_file << "abdominal_width: " << totalDistance << std::endl;
//        output_file.close();  // 关闭文件
//        std::cout << "abdominal_width saved to curve_length.txt" << std::endl;
//    }
//    else {
//        std::cerr << "Unable to open file for writing." << std::endl;
//    }
//    savePlaneAsXYZ(A, B, C, D, output_path, middle_part, resolution);
//    pcl::io::savePCDFileASCII("E:\\pig1-150\\xyz150\\xyz150\\014_new\\abdominal_width\\55_cen.pcd", *middle_part);
//
//    return 0;
//}